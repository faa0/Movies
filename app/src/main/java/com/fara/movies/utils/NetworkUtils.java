...
public class NetworkUtils {
    ...
    public static URL buildURLToVideos(int id, String lang) throws MalformedURLException {
    ...
    public static URL buildURLToReviews(int id, String lang) throws MalformedURLException {
    ...
    public static URL buildURL(int sortBy, int page, String lang) throws MalformedURLException {
        URL result = null;
        String methodOfSort;
